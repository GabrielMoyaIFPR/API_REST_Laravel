...
class RealStatePhotoController extends Controller
{
    ...
    public function setThumb($photoId, $realStateId){ 
        try{
            ...
            return response()->json(['msg' => 'Thumb atualizada com sucesso'], 200);
        }catch(\Exception $e){
    ...
    public function remove($photoId){
        try{
            ...
            if($photo->is_thumb){
                $message = new ApiMessages('Não é possível remover a foto de capa, altere a thumb e após remova a imagem desejada.');
                return response()->json($message->getMessage(), 401);
            }
            ...
            return response()->json(['msg' => 'Foto removida com sucesso'], 200);
        }catch(\Exception $e){
            $message = new ApiMessages($e->getMessage());
            return response()->json($message->getMessage(), 401);
        }
